...
# Database: php-test
# Generation Time: 2018-07-03 10:49:38 +0000
# ************************************************************
...
CREATE TABLE `cms_member` (
  ...
  `reg_type` enum('B','P') COLLATE utf8mb4_bin DEFAULT 'P' COMMENT '가입유형 / B는 기업회원, P는 개인회원',
...
INSERT INTO `cms_member` (`id`, `username`, `nickname`, `realname`, `phone`, `email`, `thumbnail`, `password`, `role`, `reg_type`, `business_name`, `business_number`, `description`, `address`, `created_dt`)
VALUES
	(1,'admin',NULL,NULL,NULL,'admin',NULL,'7110eda4d09e062aa5e4a390b0a572ac0d2c0220',X'41',NULL,NULL,NULL,NULL,NULL,'2018-06-10 08:50:56'),
	(2,'test001',NULL,NULL,NULL,NULL,NULL,'8dac20aa7da734d8ac41583a50fe59075f08ed7a',X'43',NULL,NULL,NULL,NULL,NULL,'2018-06-19 12:29:57'),
	(3,NULL,NULL,NULL,NULL,'j.lee@jcorporationtech.com',NULL,'db25f2fc14cd2d2b1e7af307241f548fb03c312a',X'55',X'50',NULL,NULL,NULL,NULL,'2018-07-03 14:50:59');
