    ...
    function html5Upload() {	
    	...
    	// TODO 위치 이동에 따라서 경로를 수정해 주어야 한다..
    	sUploadURL= '/plugin/se2/photo_uploader/popup/file_uploader_html5.php'; 	//upload URL
	 ...
	 * TODO 경로 수정
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/plugin/se2/photo_uploader/popup/file_upload_html5.php',	//샘플 URL입니다.
 	        sCallback : '/plugin/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
