...
$query='select * from `cms_board_blog` order by `id` desc limit 0, 1000;';
$rows = $db->query($query);
$db=null;


// dumdum에서 페이지네이션 로직 가져와서 붙여넣을 것 혹은
//data-table 을 연결할 것.
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title clearfix">
                            <h4>블로그</h4>
                            <a href="<?php echo ROOT;?>admin/blog/write.php" class="btn btn-sm btn-info pull-right">글쓰기</a>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class="color-primary">
                                                    ...
                                                    <?php
                                                        ...
                                                        }else if($r['blog_type'] === 'V'){
                                                            // 비디오형
                                                            echo '<i class="fab fa-youtube"></i>';
                                                        }else if($r['blog_type'] === 'G'){
                                                            // 갤러리형
                                                ...
                                                <td>
                                                    <a href="<?php echo ROOT;?>admin/blog/view.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-primary">보기</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
