    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">블로그 글쓰기</h3></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="_container">
                                <form action="./response/res_write.php" method="post" enctype="multipart/form-data" class="form">
                                    ...
                                    <div class="form-group">
                                        <input type="radio" name="blog_type" class="radio-type blog-type-thumbnail" value="T" id="T" checked />
                                        <label for="T">대표 썸네일형</label>
                                        &nbsp;&nbsp;
                                        <input type="radio" name="blog_type" class="radio-type blog-type-video" value="V" id="V" />
                                    ...
                                    <div class="form-group representative-type-thumbnail">
                                        <label for="">대표썸네일</label>
                                        <input type="file" name="thumbnail" class="form-control" placeholder="글을 대표할 썸네일을 입력해주세요." accept="image/*" />
                                    </div>

                                    <div class="form-group representative-type-video" style="display: none;">
                                        <label for="">동영상 썸네일 (Youtube)</label>
