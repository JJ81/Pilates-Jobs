    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">블로그</h3></div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <!-- 대표썸네일형일 경우 -->
                                    <?php if($row[0]['blog_type'] == 'T'){ ?>
                                    <tr>
                                        <td colspan="8">
                                            <div style="text-align: left;">대표썸네일</div>
                                    ...
                                    <?php } ?>
                                    <?php if($row[0]['blog_type'] == 'V'){ ?>
                                    <!-- 비디오썸네일일 경우 -->
                                    <tr>
                                        <td colspan="8">
                                            <div style="text-align: left;">대표비디오</div>
                                            <div style="text-align: left;">
                                                <iframe width="560" height="315" src="https://www.youtube.com/embed/rNYw9X_daEU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } ?>
