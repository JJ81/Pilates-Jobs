...
if(empty($_POST['password'])){
    AlertMsgAndRedirectTo('/admin/modify_password.php', '올바른 접근이 아닙니다.');
    exit;
}
...
if(strlen($password) < 4){
    AlertMsgAndRedirectTo('/admin/modify_password.php', '비밀번호 4자리 이상 입력해주세요.');
    exit;
}

if($password !== $re_password){
    AlertMsgAndRedirectTo('/admin/modify_password.php', '비밀번호가 일치하지 않습니다.');
    exit;
}
